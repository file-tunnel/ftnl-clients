...
check was introduced: **14 findings across 11 files
and 1,046 lines**. CI compares against that budget and fails only when a
...
| `DA005` | 3 | warn | typed errors | `throw` as control flow |
